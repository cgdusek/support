...
Video files remain on your computer at all times.
...
If authentication is enabled, access tokens are used only to authorize local connections.
...
Stopping the server immediately ends all network access.
